<html>
  ...
  <?php
    ...
    function Convert($entrada)
    {
        ...
        for($i = 0; $i < strlen( $entrada ); $i++)
        {
            switch($entrada[$i])
            {
              ...
              case '&': case '|':
                while($pila->vacia() != true && Priority($entrada[$i]) <= Priority($pila->tope()))
                {
                  $posf = $posf.$pila->tope()." ";
                  $pila->pop();
                }
    ...
    function create_Table1( $array, $j )
    {
        print( "<table border='1' align='center' bgcolor='#E6E6E6'>" );
            ...
            print( "<TR>" );
                print( "<TH width='120'>Identificador</TH>" );
                print( "<TH width='100'>Termino</TH>" );
                print( "<TH width='120'>Id_documento</TH>" );
            print( "</TR>" );
        print( "</table>" );
        ...
        for( $i = 1; $i <= $j; $i++ )
        {
            print( "<table border='1' align='center' bgcolor='#E6E6E6'>" );
                print( "<TR>" );
                    print( "<TD width='115' align=center >T$i</TD>" );
                    print( "<TD width='115' align=center >{$array[$i-1]}</TD>" );
                    $id_doc = id_Document( $array[$i-1]);
                    print( "<TD width='115' align=center>$id_doc</TD>" );
                print( "</TR>" );
            print( "</table>" );
        }
    }

    function Is_In( $nombre_doc, $termino )
    {
    ...
    function Create_Table2( $array, $j )
    {
        print( "<table border='1' align='center' bgcolor='#E6E6E6'>" );
            print( "<TR>" );
        ...
        for( $i = 1; $i <= $j; $i++ )
        {
            ...
            print( "<TR>" );
                ...
                $cero_uno = Is_In( "d1.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d2.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d3.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d4.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d5.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d6.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d7.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d8.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d9.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
                $cero_uno = Is_In( "d10.txt", $array[$i-1] );
                $matriz[$i-1][$indice++]= $cero_uno;
                print( "<TD width='51' align=center >$cero_uno</TD>" );
            print( "</TR>" );
        print( "</table>" );
    ...
    error_reporting(E_ALL ^ E_WARNING);
      ...
      create_Table1( $array, $j );
      print( "<br><br>" );
      Create_Table2( $array, $j );
	 
      echo "<br>"."<br>";
  	  echo "Consulta_Entrada(infija):		".$entrada."<br>";
  	  echo "Consulta_Postfija:		"."<br>";
      $cad_procesar = Convert( $entrada );
  	  
      echo $cad_procesar."<br>";
        $resultado = Evaluate( $cad_procesar );
