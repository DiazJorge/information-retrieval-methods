...
<body>
	<header>
		<nav>
			<ul>
				<li><a href="validar.php"><span class="primero"><i class="icon icon-flickr2"></i></span>Binario</a></li>
				...
				<li><a href="frecuencias.php"><span class="tercero"><i class="icon icon-stats-bars"></i></span>Probabilistico</a></li>
